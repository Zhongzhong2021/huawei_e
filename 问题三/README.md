...
附件4全部20条的已有预测、主模型解释及可读卡片见 [全20条解释卡](results/附件4_全20条解释卡.md)。论文为 [Word 文档](paper/问题三_不确定性融合论文.docx)，同目录 `build_paper.py` 可从冻结结果再生。模型方法、代码来源和复现边界见[模块说明](docs/模块说明.md)与[模型来源与复现实验说明](docs/模型来源与复现实验说明.md)。
