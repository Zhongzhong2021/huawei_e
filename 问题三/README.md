...
论文另补充原生结构四格对照、两组学习率试验，以及SELF-MM/源码TETFN的8组参数对照，含较弱配置及相应参考配置。完整22组原生参数、8组开源适配参数及来源见[补充对照实验说明](docs/补充对照实验说明.md)。开源参数对照含验证重放与冻结策略的附件二测试结果，原训练上限为10轮，未冒称20轮实验。
