...
第四轮材料独立保存在当前Windows工作区的 `output/e_q2/round4/`。其中 `reports/` 是8页论文补充Word、Markdown、4个可编辑公式与8张数据表；`figures/` 是4组SVG、PDF和600 dpi PNG；`final/` 是当前模型、标准化参数及30条附件3预测。旧第三轮交接包不包含第四轮模型。
